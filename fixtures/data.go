...
func generateStandardBox(location string, names PrizeNames) model.Box {
	return model.Box{
		...
		Prizes: []model.Prize{
			...
			},
			{
				...
				Phases: []model.ProbabilityPhase{{StartDrawCount: 0, EndDrawCount: 80, Weight: 20}},
			},
			{
				Level: "C", Name: names.C, InitialQuantity: 10, RemainingQuantity: 10,
				Phases: []model.ProbabilityPhase{{StartDrawCount: 0, EndDrawCount: 80, Weight: 100}},
			},
			{
				Level: "D", Name: names.D, InitialQuantity: 27, RemainingQuantity: 27,
				Phases: []model.ProbabilityPhase{{StartDrawCount: 0, EndDrawCount: 80, Weight: 270}},
			},
			{
				Level: "E", Name: names.E, InitialQuantity: 40, RemainingQuantity: 40,
				Phases: []model.ProbabilityPhase{{StartDrawCount: 0, EndDrawCount: 80, Weight: 400}},
			},
			{
				Level: "LastOne", Name: names.LastOne, InitialQuantity: 1, RemainingQuantity: 1,
				Phases: []model.ProbabilityPhase{{StartDrawCount: 0, EndDrawCount: 80, Weight: 0}}, // 不參與機率分配
			},
		},
	}
}
